...
|---:|---:|---:|---:|---:|---|
|1|41.05|41.05|229.66|5457|`compute_rhs_bssn_`|
|2|24.94|65.99|139.54|1765914927|`polint_`|
|3|5.99|71.98|33.52|130968|`lopsided_`|
|4|5.08|77.06|28.40|60027|`fdderivs_`|
|5|4.65|81.71|26.00|251030|`prolong3_`|
|6|4.10|85.81|22.94|130968|`kodis_`|
|7|3.73|89.54|20.87|91237|`fderivs_`|
|8|1.86|91.40|10.42||`_init`|
|9|1.67|93.07|9.35|5280|`enforce_ga_`|
|10|1.43|94.50|7.99|126720|`rungekutta4_rout_`|
|11|1.36|95.86|7.63|796440|`symmetry_bd_`|
|12|1.22|97.08|6.80|41067789|`polin3_`|
|13|0.64|97.72|3.59|130290|`restrict3_`|
|14|0.52|98.24|2.89|41067789|`decide3d_`|
|15|0.40|98.64|2.25|15936|`average2_`|
|16|0.22|98.86|1.24|521994240|`misc::fact(int)`|
|17|0.18|99.04|1.01|1627131|`copy_`|
|18|0.18|99.22|1.01|240|`admmass_bssn_`|
|19|0.14|99.36|0.78|41067789|`global_interp_`|
|20|0.13|99.49|0.74|20|`getnp4_`|
|21|0.12|99.61|0.69|1760|`Patch::Interp_Points(MyList<var>*, int, double**, double*, int)`|
|22|0.07|99.68|0.38|46448640|`misc::Wigner_d_function(int, int, int, double)`|
|23|0.06|99.74|0.36|5280|`lowerboundset_`|
|24|0.06|99.80|0.33|240|`surface_integral::surf_Wave(double, int, cgh*, var*, var*, int, int, int, double*, double*, monitor*)`|
|25|0.06|99.86|0.31|607446|`Ansorg::interpolate_tri_bar(double, double, double, int, int, int, double*, double*, double*, double*)`|
|26|0.02|99.88|0.13|872106|`monitor::monitor(char const*, int, std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >)`|
...
|29|0.01|99.93|0.07|840|`l2normhelper_`|
|30|0.01|99.94|0.06|124800|`sommerfeld_rout_`|
|31|0.01|99.95|0.05|9|`get_ansorg_nbhs_`|
|32|0.01|99.96|0.04|240|`surface_integral::surf_MassPAng(double, int, cgh*, var*, var*, var*, var*, var*, var*, var*, var*, var*, var*, var*, var*, var*, var*, var*, var*, var*, var*, var*, var*, double*, monitor*)`|
|33|0.01|99.97|0.03|231952|`Parallel::build_gstl(MyList<Parallel::gridseg>*, MyList<Parallel::gridseg>*, MyList<Parallel::gridseg>**, MyList<Parallel::gridseg>**)`|
|34|0.01|99.98|0.03|1920|`sommerfeld_routbam_`|
|35|0.00|99.98|0.02|13214167|`Block::getdX(int)`|
|36|0.00|99.98|0.02|120|`average_`|
|37|0.00|99.98|0.01|1822338|`Ansorg::find_point_bisection(double, int, double*, int)`|
|38|0.00|99.98|0.01|607446|`Ansorg::xyz_to_ABp(double, double, double, double*, double*, double*)`|
|39|0.00|99.98|0.01|230517|`Patch::Interp_ONE_Point(MyList<var>*, double*, double*, int)`|
|40|0.00|99.98|0.01|150168|`Parallel::gs_subtract(MyList<Parallel::gridseg>*, MyList<Parallel::gridseg>*)`|
|41|0.00|99.98|0.01|42240|`Block::swapList(MyList<var>*, MyList<var>*, int)`|
|42|0.00|99.98|0.01|1093|`Parallel::prepare_inter_time_level(Patch*, MyList<var>*, MyList<var>*, MyList<var>*, MyList<var>*, int)`|
|43|0.00|99.98|0.00|701658|`Patch::getdX(int)`|
|44|0.00|99.98|0.00|607446|`Ansorg::ps_u_at_xyz(double, double, double)`|
|45|0.00|99.98|0.00|140352|`Parallel::build_owned_gsl2(Patch*, int)`|
...
|48|0.00|99.98|0.00|35552|`Parallel::build_owned_gsl4(Patch*, int, int)`|
|49|0.00|99.98|0.00|21821|`Parallel::build_complete_gsl(Patch*)`|
|50|0.00|99.98|0.00|21000|`cgh::Interp_One_Point(MyList<var>*, double*, double*, int)`|
|51|0.00|99.98|0.00|19327|`Parallel::gsl_subtract(MyList<Parallel::gridseg>*, MyList<Parallel::gridseg>*)`|
|52|0.00|99.98|0.00|19278|`Parallel::build_buffer_gsl(Patch*)`|
|53|0.00|99.98|0.00|14923|`Parallel::build_ghost_gsl(Patch*)`|
|54|0.00|99.98|0.00|14923|`Parallel::Sync(Patch*, MyList<var>*, int)`|
|55|0.00|99.98|0.00|8212|`Parallel::Sync(MyList<Patch>*, MyList<var>*, int)`|
